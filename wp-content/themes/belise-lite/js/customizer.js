...
( function( $ ) {
	...
	// Header phone
	wp.customize( 'belise_contact_phone', function( value ) {
		value.bind( function( to ) {
			if( to !== '' ){
	...
	// Footer e-mail
	wp.customize( 'belise_contact_email', function( value ) {
		value.bind( function( to ) {
			if( to !== '' ){
    ...
    // Front page title
   wp.customize( 'belise_front_page_title', function( value ) {
        value.bind( function( to ) {
            if( to !== '' ){
    ...
    wp.customize( 'belise_front_page_button', function( value ) {
        value.bind( function( to ) {
            if( to !== '' ){

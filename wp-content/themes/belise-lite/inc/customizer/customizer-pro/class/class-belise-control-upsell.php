...
if ( ! class_exists( 'Belise_Control_Upsell' ) ) :
	/**
	 * Class Belise_Control_Upsell
	 */
	class Belise_Control_Upsell extends WP_Customize_Control {
		...
		/**
		 * Belise_Control_Upsell constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Belise_Control_Upsell' );
		...
		public function enqueue() {
			wp_enqueue_style( 'themeisle-upsell-style', get_template_directory_uri() . '/inc/customizer/customizer-pro/css/style.css', '1.0.0' );
		}
